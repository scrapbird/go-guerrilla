...
import (
	...
	"github.com/scrapbird/go-guerrilla/log"

	// enable the Redis redigo driver
	_ "github.com/scrapbird/go-guerrilla/backends/storage/redigo"

	// Choose iconv or mail/encoding package which uses golang.org/x/net/html/charset
	//_ "github.com/scrapbird/go-guerrilla/mail/iconv"
	_ "github.com/scrapbird/go-guerrilla/mail/encoding"
